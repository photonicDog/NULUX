...
namespace Dialogue_System {
    public class DialogueUINulux : Yarn.Unity.DialogueUIBehaviour {
        ...
        public DialogueTalkspriter talkspriteManager;
        ...
        /// <summary>
        /// A <see cref="DialogueRunner.StringUnityEvent"/> that is called
        /// when the visible part of the line's nameplate changes.
        /// </summary>
        /// <remarks>
        /// The <see cref="string"/> parameter that this event receives is
        /// the text that should be displayed to the user. Use this method
        /// to display nameplate text to the user.
        /// </remarks>
        public DialogueRunner.StringUnityEvent onNameplateUpdate;
        ...
        */
        ...
        private  IEnumerator DoRunOptions (Yarn.OptionSet optionsCollection, ILineLocalisationProvider localisationProvider, System.Action<int> selectOption)
        {
            ...
            foreach (OptionSet.Option optionString in optionsCollection.Options) {
                ...
                string optionText = localisationProvider.GetLocalisedTextForLine(optionString.Line);
                ...
                Text unityText = optionButtons [i].GetComponentInChildren<Text> ();
                if (unityText != null) {
                    unityText.text = optionText;
                }

                TMP_Text textMeshProText = optionButtons [i].GetComponentInChildren<TMPro.TMP_Text> ();
